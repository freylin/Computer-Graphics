...
void displayHeader() { // Displays title and authors face on screen
    ...
    image(YaohongPix, width-YaohongPix.width/2,25,YaohongPix.width/2,YaohongPix.height/2); 
    image(JinPix, width-YaohongPix.width-JinPix.width/2,25,JinPix.width/2,JinPix.height/2); 
    }
